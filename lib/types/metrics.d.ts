...
export declare const emptyTurnMetricState: TurnMetricState;
/**
 ...
 */
export declare function foldTurnMetrics(state: TurnMetricState, event: SessionEvent): {
    readonly state: TurnMetricState;
