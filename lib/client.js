		...
		function apply(ctx) {
			...
			const executeRoom = async (line) => {
				...
				try {
					...
					if (result.value === void 0) return `unknown or malformed command: ${line}`;
