window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-bg-css:D:\deepseek-harness\Project\Plugins\dsh-background-agents\src\client\BackgroundAgentsAction.module.css.mjs
		const css = ".ooanTW_triggerWrap{justify-content:center;display:flex;position:relative}.ooanTW_trigger{height:32px;color:inherit;cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:6px;padding:0 8px;display:flex}.ooanTW_trigger:hover{background:var(--color-bg-hover,#8080801f)}.ooanTW_triggerIcon{font-size:12px;line-height:1}.ooanTW_triggerLabel{white-space:nowrap;font-size:12px}.ooanTW_count{background:var(--color-accent,light-dark(#4d6bfe,#5d7aff));color:#fff;text-align:center;border-radius:8px;min-width:16px;padding:0 4px;font-size:10px;line-height:16px}.ooanTW_panel{z-index:1000;border:1px solid var(--color-border,#8080803d);background:var(--color-bg-elevated,light-dark(#fff,#1e1e1e));border-radius:10px;width:320px;max-height:60vh;padding:12px;position:fixed;bottom:64px;right:16px;overflow-y:auto;box-shadow:0 8px 32px #0000002e}.ooanTW_panelTitle{margin-bottom:8px;font-size:13px;font-weight:600}.ooanTW_empty{opacity:.7;padding:12px 0;font-size:12px}.ooanTW_error{color:light-dark(#c92a2a,#ff8f8f);background:light-dark(#c92a2a1f,#ff87871f);border-radius:6px;margin-bottom:8px;padding:6px 8px;font-size:12px}.ooanTW_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.ooanTW_row{border:1px solid var(--color-border,#8080803d);border-radius:8px;padding:8px}.ooanTW_rowHead{align-items:center;gap:6px;display:flex}.ooanTW_status{white-space:nowrap;border-radius:8px;flex:none;padding:1px 6px;font-size:10px;line-height:16px}.ooanTW_status-running{color:light-dark(#4d6bfe,#7c9bff);background:light-dark(#4d6bfe24,#5d7aff24)}.ooanTW_status-idle{color:inherit;background:#80808029}.ooanTW_status-settled{color:light-dark(#2cac52,#6fd48f);background:light-dark(#2cac5224,#5fce8324)}.ooanTW_status-archived{color:light-dark(#e69138,#f2b269);background:light-dark(#e6913824,#f2b26924)}.ooanTW_label{text-overflow:ellipsis;white-space:nowrap;flex:auto;font-size:12px;overflow:hidden}.ooanTW_meta{opacity:.7;flex:none;font-size:10px}.ooanTW_lastMessage{opacity:.85;text-overflow:ellipsis;white-space:nowrap;margin-top:4px;font-size:11px;overflow:hidden}.ooanTW_actions{gap:6px;margin-top:6px;display:flex}.ooanTW_action{border:1px solid var(--color-border,#8080803d);color:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:3px 10px;font-size:11px}.ooanTW_action:hover:not(:disabled){background:var(--color-bg-hover,#8080801f)}.ooanTW_action:disabled{opacity:.5;cursor:default}.ooanTW_composer{gap:6px;margin-top:6px;display:flex}.ooanTW_composerInput{border:1px solid var(--color-border,#8080803d);min-width:0;color:inherit;background:0 0;border-radius:6px;flex:auto;padding:3px 8px;font-size:11px}";
		...
		var BackgroundAgentsAction_module_css_default = {
			"status-running": "ooanTW_status-running",
			"triggerLabel": "ooanTW_triggerLabel",
			"status-settled": "ooanTW_status-settled",
			"status": "ooanTW_status",
			"lastMessage": "ooanTW_lastMessage",
			"meta": "ooanTW_meta",
			"row": "ooanTW_row",
			"action": "ooanTW_action",
			"triggerWrap": "ooanTW_triggerWrap",
			"composer": "ooanTW_composer",
			"error": "ooanTW_error",
			"composerInput": "ooanTW_composerInput",
			"rowHead": "ooanTW_rowHead",
			"actions": "ooanTW_actions",
			"panel": "ooanTW_panel",
			"empty": "ooanTW_empty",
			"rows": "ooanTW_rows",
			"trigger": "ooanTW_trigger",
			"panelTitle": "ooanTW_panelTitle",
			"status-idle": "ooanTW_status-idle",
			"label": "ooanTW_label",
			"status-archived": "ooanTW_status-archived",
			"count": "ooanTW_count",
			"triggerIcon": "ooanTW_triggerIcon"
		};
		//#endregion
		...
		*/
		...
		function BackgroundAgentsAction({ wide, t, useSessions, openChild, stopChild, sendMessage }) {
