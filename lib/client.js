window.__ModuleLoader__.load({
	...
	factory: (require) => {
			...
			for (const parent of Object.values(list.byId)) {
				...
				for (const entry of projection.agents) {
					...
					rows.push({
						...
						...entry.metrics === void 0 ? {} : { metrics: entry.metrics }
					});
				}
			}
		...
		*/
		function buildCostReport(rows, now) {
			return {
				generatedAt: now,
				agents: rows.map((row) => {
					const metrics = row.metrics;
					const errorRate = metrics === void 0 || metrics.turnCount === 0 ? null : metrics.errorCount / metrics.turnCount;
					return {
						agentId: row.agentId,
						label: row.label,
						status: row.status,
						turnCount: metrics?.turnCount ?? 0,
						durationMs: metrics === void 0 ? null : metrics.totalDurationMs,
		...
		const css$1 = ".fCmbna_triggerWrap{justify-content:center;display:flex;position:relative}.fCmbna_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary,inherit);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:6px;padding:0 8px;font-size:12px;line-height:18px;display:inline-flex}.fCmbna_trigger:hover,.fCmbna_trigger:focus-visible{background:var(--dsw-alias-interactive-bg-hover,#8080801f);color:var(--dsw-alias-label-secondary,inherit)}.fCmbna_triggerIcon{flex:none;justify-content:center;align-items:center;display:inline-flex}.fCmbna_triggerIcon svg{transition:transform .12s}.fCmbna_triggerLabel{white-space:nowrap;font-size:12px}.fCmbna_count{background:var(--color-accent,light-dark(#4d6bfe,#5d7aff));color:#fff;text-align:center;border-radius:8px;min-width:16px;padding:0 4px;font-size:10px;line-height:16px}.fCmbna_panel{z-index:1000;border:1px solid var(--dsw-alias-border-l2,#8080803d);background:var(--dsw-specific-menu,var(--color-bg-elevated,light-dark(#fff,#1e1e1e)));width:320px;max-width:min(400px,100vw - 32px);max-height:60vh;box-shadow:var(--dsw-shadow-lv3,0 8px 32px #0000002e);border-radius:12px;outline:none;padding:12px;position:fixed;overflow-y:auto}.fCmbna_panelTitle{color:var(--dsw-alias-label-primary,inherit);margin-bottom:8px;font-size:13px;font-weight:600}.fCmbna_empty{opacity:.7;padding:12px 0;font-size:12px}.fCmbna_error{color:light-dark(#c92a2a,#ff8f8f);background:light-dark(#c92a2a1f,#ff87871f);border-radius:6px;margin-bottom:8px;padding:6px 8px;font-size:12px}.fCmbna_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.fCmbna_row{border:1px solid var(--dsw-alias-border-l2,#8080803d);border-radius:8px;padding:8px}.fCmbna_rowHead{align-items:center;gap:6px;display:flex}.fCmbna_status{white-space:nowrap;border-radius:8px;flex:none;padding:1px 6px;font-size:10px;line-height:16px}.fCmbna_status-running{color:light-dark(#4d6bfe,#7c9bff);background:light-dark(#4d6bfe24,#5d7aff24)}.fCmbna_status-idle{color:inherit;background:#80808029}.fCmbna_status-settled{color:light-dark(#2cac52,#6fd48f);background:light-dark(#2cac5224,#5fce8324)}.fCmbna_status-archived{color:light-dark(#e69138,#f2b269);background:light-dark(#e6913824,#f2b26924)}.fCmbna_label{text-overflow:ellipsis;white-space:nowrap;flex:auto;font-size:12px;overflow:hidden}.fCmbna_parentTitle{opacity:.6;text-overflow:ellipsis;white-space:nowrap;margin-top:2px;font-size:10px;overflow:hidden}.fCmbna_meta{opacity:.7;flex:none;font-size:10px}.fCmbna_lastMessage{opacity:.85;text-overflow:ellipsis;white-space:nowrap;margin-top:4px;font-size:11px;overflow:hidden}.fCmbna_result{background:var(--dsw-alias-interactive-bg-hover,#80808014);border-radius:6px;margin-top:6px;padding:6px 8px}.fCmbna_resultText{white-space:pre-wrap;word-break:break-word;max-height:160px;font-size:11px;line-height:1.5;overflow-y:auto}.fCmbna_resultLoading{opacity:.7;font-size:11px}.fCmbna_resultError{color:light-dark(#c92a2a,#ff8f8f);font-size:11px}.fCmbna_actions{gap:6px;margin-top:6px;display:flex}.fCmbna_action{border:1px solid var(--dsw-alias-border-l2,#8080803d);color:var(--dsw-alias-label-primary,inherit);cursor:pointer;background:0 0;border-radius:6px;padding:3px 10px;font-size:11px}.fCmbna_action:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,#8080801f)}.fCmbna_action:disabled{opacity:.5;cursor:default}.fCmbna_composer{gap:6px;margin-top:6px;display:flex}.fCmbna_composerInput{border:1px solid var(--dsw-alias-border-l2,#8080803d);min-width:0;color:inherit;background:0 0;border-radius:6px;flex:auto;padding:3px 8px;font-size:11px}.fCmbna_exportRow{gap:6px;margin-bottom:8px;display:flex}.fCmbna_metrics{opacity:.75;flex-wrap:wrap;gap:4px 10px;margin-top:4px;font-size:10px;display:flex}.fCmbna_metrics span{white-space:nowrap}";
		const tagId$1 = "dsh-background-agents/BackgroundAgentsAction.module.css";
		...
		var BackgroundAgentsAction_module_css_default = {
			...
			"empty": "fCmbna_empty",
			"error": "fCmbna_error",
			"exportRow": "fCmbna_exportRow",
			"label": "fCmbna_label",
			"lastMessage": "fCmbna_lastMessage",
			"meta": "fCmbna_meta",
			"metrics": "fCmbna_metrics",
			"panel": "fCmbna_panel",
		...
		*/
		...
		function Row({ row, t, now, busy, showParent, composing, draft, result, onResult, onCloseResult, onDraft, onOpen, onStop, onCompose, onSend, onCancel }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [
					...
					row.metrics !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: BackgroundAgentsAction_module_css_default.metrics,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("metrics.turns", { n: row.metrics.turnCount }) }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("metrics.duration", { n: fmtDuration(row.metrics.totalDurationMs) }) }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("metrics.tokens", {
								input: fmtTokens(row.metrics.inputTokens),
								output: fmtTokens(row.metrics.outputTokens)
							}) }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("metrics.errors", { n: row.metrics.errorCount }) })
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function BackgroundAgentsAction({ wide, t, sessions, openChild, stopChild, sendMessage, readResult }) {
			...
			const rows = buildAgentRows((0, react.useSyncExternalStore)(sessions.subscribe, sessions.getSnapshot));
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
					...
					children: [
						...
						rows.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: BackgroundAgentsAction_module_css_default.exportRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: BackgroundAgentsAction_module_css_default.action,
								onClick: downloadCost,
								children: t("export.download")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: BackgroundAgentsAction_module_css_default.action,
								onClick: () => {
		...
		//#endregion
		//#region \0dsh-bg-css:src/client/TeamRoomsSection.module.css.mjs
		...
		const tagId = "dsh-background-agents/TeamRoomsSection.module.css";
		...
		*/
		var TeamRoomsController = class {
			...
			stopList;
			stopFace;
			stopRetainInfo = /* @__PURE__ */ new Map();
			boundSessionId;
			...
			*/
			mainViewSessionId() {
				...
				for (const [id, stop] of this.stopRetainInfo) if (!live.has(id)) {
					stop();
					this.stopRetainInfo.delete(id);
				}
				let mainView;
				for (const id of ids) {
					if (!this.stopRetainInfo.has(id)) this.stopRetainInfo.set(id, this.sessions.retainInfo(id).subscribe(() => {
						this.refresh();
					}));
					if (((this.sessions.retainInfo(id).getSnapshot()?.retainedBy ?? {})["mainView"] ?? 0) > 0 && mainView === void 0) mainView = id;
				}
				return mainView;
			}
			refresh() {
		...
		*/
		function apply(ctx) {
			...
			ctx.effect(() => ctx.locale.register(ROOM_NS, {
				zh,
				en
			}), "dsh-background-agents: room dictionaries");
				...
				inject: () => ({
					...
					async openChild(parentSessionId, childSessionId) {
						try {
							...
							const detail = sessions.subagentAddress(childSessionId) === void 0 ? `no live subagent address for ${childSessionId}` : "the subagent address for this child is live";
							console.warn(`dsh-background-agents: client-side subagent navigation was removed in 0.1.6-alpha.2 — navigation belongs to the view owners and ui-subagent owns the session-header lineage seat; open the child from the session header instead (${detail}).`);
					...
					async stopChild(parentSessionId, childSessionId) {
						try {
							const result = await api.subagents.interruptByParent(childSessionId, parentSessionId, "continuable");
					...
					async readResult(_parentSessionId, childSessionId) {
						try {
							const face = sessions.binding(childSessionId)?.session.projections.faceOf("conversation");
							if (face === void 0) return {
								text: "",
								error: "child transcript projection unavailable"
							};
							const snapshot = face.getSnapshot();
							return { text: extractResultText(snapshot.entries ?? snapshot) };
						} catch (error) {
							return {
								text: "",
