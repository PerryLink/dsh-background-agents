...
| 方面 | 状态 |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-alpha.1`（GitHub tag，2026-09-09 已核验；npm 依赖钉号 `0.1.2-rc.1`（latest）/ `0.1.5-alpha.1`（alpha），peer 依赖 `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0`） |
| Node | `^22.19.0 \|\| >=24.0.0` |
