...
Este proyecto es uno de los plugins de DeepSeek Harness mantenidos por [PerryLink](https://github.com/PerryLink). Si este te ayuda, es probable que los demás también:

| Plugin | Resumen en una línea |
|---|---|
...
| **[dsh-background-agents](https://github.com/PerryLink/dsh-background-agents)** | Agentes hijos de fondo duraderos con una barra lateral de interfaz web, mensajería e interrupción |
| [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | Diagnósticos, formateo, completado, acciones de código y renombrado LSP sobre servidores de lenguaje |
...
| [dsh-permission-rules](https://github.com/PerryLink/dsh-permission-rules) | Reglas de permiso declarativas allow/deny/ask al estilo de Claude Code con auditoría |
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | Revisión automática de segundo modelo en la cadena de aprobación, con cierre en fallo por defecto |
...
| [dsh-session-pin](https://github.com/PerryLink/dsh-session-pin) | Fija sesiones en la barra lateral web con ordenación duradera |
