...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-alpha.1` (GitHub tag, verified 2026-09-09; npm pins `0.1.2-rc.1` (latest) / `0.1.5-alpha.1` (alpha), peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
