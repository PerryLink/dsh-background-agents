...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-rc.1` (GitHub tag, verified 2026-09-24; dev pins `0.1.7-rc.1`, peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
- **injected `user/message` notices** (model-visible), source `{ kind: 'dsh-background-agents', form: 'notice' }` — the throttled progress lines and archive notices (canonical `[background-agent <id>] …` prefix).
