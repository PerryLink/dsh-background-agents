...
0.1.3-alpha.1 (2026-09-06 को अनुकूलित): CI हार्नेस पिन मास्टर checkout (`d347e7039`) पर चला जाता है - session-persistence सेवा का हैंडल सीम (`open → read → close`)। प्रकाशित 0.1.2-rc.1 रनटाइम open() से पहले का है, इसलिए bg_result की कोल्ड रीड सीम का पता लगाकर load() पर फ़ॉलबैक करती है - दोनों लाइनों पर व्यवहार समान है।
